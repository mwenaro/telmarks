...
<div class="section" id="writing" style="margin-top: 30px;">
    <div class="container">
        <p style="font-weight: bold; line-height: 1.5; text-align: left;">WRITING PACKAGE <br> Pricing</p>
        <hr class="mx-auto mb-5 w-100" />
        <div class="row justify-content-center">
            <div class="col-12 col-sm-6 col-md-3 m-2">
                <div class="card shadow" id="star-package">
                    <div class="card-body" style="text-align: center;">
                        <form id="purchaseForm">
                                <p class="card-img-top" style="font-size: 24px;">
                                    <br>
                                    <br>
                                    <span style="font-size: 18px; color: #000;">ACADEMIC WRITING</span><br>
                                    <span style="font-size: 18px; color: #000;">KES</span><br>
                                    <span style="font-size: 45px; color: #000;">13,000</span><br>
                                    <input type="hidden" name="selected_amount" value="13000">
                                    <input type="hidden" name="selected_package" value="Academic Writing">
                                    <input type="hidden" name="selected_cashback" value="9000">
                                    Lifetime
                                </p>
                                <hr class="mx-auto w-75" />
                                <p>
                                    Cashback 9,000 <br> Assignment<br> Essays <br> Earn 500 @ Page daily <br> Max of 10
                                    Pages Per Day <br>
                                </p>
                                ...
                                <button class="btn" style="background-color: #f36c33; color: #fff;"
                                        ...
                                        onmouseout="this.style.backgroundColor='#f36c33'; this.style.color='#fff';"
                                        onclick="purchasePackage(this)">Purchase</button>
                            </form>
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-6 col-md-3 m-2">
                <div class="card shadow" id="platinum-package">
                    <div class="card-body" style="text-align: center;">
                        <form id="purchaseForm">
                            <p class="card-img-top" style="font-size: 24px;">
                                <br>
                                <br>
                                <span style="font-size: 18px; color: #000;">ARTICLE WRITING</span><br>
                                <span style="font-size: 18px; color: #000;">KES</span><br>
                                <span style="font-size: 45px; color: #000;">10,000</span><br>
                            <input type="hidden" name="selected_amount" value="10000">
                            <input type="hidden" name="selected_package" value="Article Writing">
                            <input type="hidden" name="selected_cashback" value="7000">
                                Lifetime
                            </p>
                            <hr class="mx-auto w-75" />
                            <p>
                                Cashback 7,000 <br> Receive Jobs From <br> Different Companies <br> Earn 600 @ Page
                                <br> Magazine Articles Reports
                            </p>
...
<div id="content-wrapp" style="background: #fff; padding: 40px;">
    ...
    function populateTable(page) {
        ...
        fetch("writingfetch.php") // Adjust the path if needed
