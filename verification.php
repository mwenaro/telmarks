...
<div class="section" id="verification" style="margin-top: 30px;">
    <div class="container">
        <p style="font-weight: bold; line-height: 1.5;">AGENT VERIFICATION <br> Pricing</p>
        ...
        <div class="row mb-5">
                    ...
                    <div class="card-body" style="text-align: center;">
                        <form id="purchaseForm">
                            <p class="card-img-top" style="font-size: 24px;">
                                <br>
                                <span style="font-size: 18px; color: #000;">AGENT VERIFICATION</span><br>
                                <span style="font-size: 18px; color: #000;">KES</span><br>
                                <span style="font-size: 45px; color: #000;">6,000</span><br>
                                Lifetime
                            </p>
                            <hr class="mx-auto w-75" />
                            <input type="hidden" name="selected_amount" value="6000">
                            <input type="hidden" name="selected_package" value="Agent verification">
                            <input type="hidden" name="selected_cashback" value="4700">
                            <p>
                                Cashback 4,700 <br> <br> <br> <br> <br> <br>
                            </p>
            ...
            <div class="container">
                <p style="font-weight: bold; line-height: 1.5;">PURCHASED PACKAGES</p>
 ...
 <div id="content-wrapp" style="background: #fff; padding: 40px;">
    ...
    document.getElementById('purchaseButton').addEventListener('click', function () {
        ...
        var selectedAmount = document.getElementsByName('selected_amount')[0].value;
        var selectedPackage = document.getElementsByName('selected_package')[0].value;
        var selectedCashback = document.getElementsByName('selected_cashback')[0].value;
    ...
    function populateTable(page) {
        ...
        fetch("verificationfetch.php") // Adjust the path if needed
