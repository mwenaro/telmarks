...
<body>
    ...
    <div class="page-content p-5" id="content">
        ...
        <div class="section" id="authorization" style="margin-top: 30px;">
            <div class="container">
                <p style="font-weight: bold; line-height: 1.5;">AGENT AUTHORIZATION <br> Pricing</p>
                        ...
                        <div class="card shadow" id="gold-package">
                            <div class="card-body" style="text-align: center;">
                                <p class="card-img-top" style="font-size: 24px;">
                                    <br>
                                    <span style="font-size: 18px; color: #000;">AGENT AUTHORIZATION</span><br>
                                    <span style="font-size: 18px; color: #000;">KES</span><br>
                                    <span style="font-size: 45px; color: #000;">5,000</span><br>
                                    Lifetime
                                </p>
                                <hr class="mx-auto w-75" />
                                 <input type="hidden" name="selected_amount" value="5000">
                                <input type="hidden" name="selected_package" value="Agent authorization">
                                <input type="hidden" name="selected_cashback" value="3700">
                                <p>
                                    Cashback 3700 <br> <br> <br> <br> <br> <br>
                                </p>
                                <button class="btn" style="background-color: #f36c33; color: #fff; outline: none;"
 ...
 <div id="content-wrapp" style="background: #fff; padding: 40px;">
    ...
    function populateTable(page) {
        ...
        fetch("authorizationfetch.php") // Adjust the path if needed
