...
<body>
    ...
    <div class="page-content p-5" id="content">
            ...
            <div class="container">
                <p style="font-weight: bold; line-height: 1.5;" class="text-center">WHATSAPP WITHDRAWAL DATA</p>
...
<div id="content-wrapp" style="background: #fff; padding: 40px;">
    <div id="table-container">
        ...
        <table class="table" id="my-table">
            <thead>
                <tr>
                    <th class="line">Request ID</th>
                    <th class="line">Points to Withdraw</th>
                    <th class="line">Request Date</th>
                    <th class="line">Username</th>
                    <th class="line">Status</th>
                    <th class="line">Action</th> <!-- Add a new column for the "Update" buttons -->
                </tr>
            </thead>
            <tbody id="table-body">
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function populateTable(page, search = '') {
        ...
        fetch(`whats.php?page=${page}&entries=${entriesPerPage}&search=${search}`)
    ...
    function attachUpdateEventListeners() {
        ...
        updateButtons.forEach(button => {
            button.addEventListener('click', function() {
                ...
                // Send an AJAX or Fetch request to update the status in the database
                fetch(`update_status.php?request_id=${requestId}&new_status=${newStatus}`, {
                    method: 'POST',
                    // You may need to add headers and other options depending on your server setup
                })
                .then(response => response.text())
                .then(data => {
                    // Handle success or error response
                    console.log(data);
                    // Optionally, you can update the table after a successful update
                    updateTable();
                })
                .catch(error => {
