...
<body>
    ...
    <div class="page-content p-5" id="content">
            ...
            <div class="container">
                <p style="font-weight: bold; line-height: 1.5;">PURCHASED AGENT AUTHORIZATION PACKAGES</p>
 ...
 <div id="content-wrapp" style="background: #fff; padding: 40px;">
    ...
    function populateTable(page, search = '') {
        ...
        fetch(`authorizationfetch_admin.php?page=${page}&search=${search}`) // Adjust the path if needed
