...
<div class="section" id="writing" style="margin-top: 30px;">
    ...
    <div class="container">
        <p style="font-weight: bold; line-height: 1.5;" class="text-center">PLATINUM AFFILIATES</p>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function populateTable(page) {
        ...
        fetch("platinumpurchase.php") // Update with the correct path to your PHP script
