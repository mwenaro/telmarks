...
<div class="section" id="writing" style="margin-top: 30px;">
    ...
    <div class="container">
        <p style="font-weight: bold; line-height: 1.5;" class="text-center">ALL AFFILIATES</p>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function populateTable(page) {
        ...
        fetch("affiliatepurchase.php") // Update with the correct path to your PHP script
