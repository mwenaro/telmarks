                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 offset-lg-3">
                            <form class="contact-form" action="screenshotsubmit.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="email">Number of Views</label>
                                    <input type="number" name="views" class="form-control" id="views" required>
                                </div>
                                <div class="form-group">
                                    <label for="cover-letter">Upload ScreenShot Image</label>
                                    <div class="custom-file">
                                        <input type="file" name="cover" class="custom-file-input" id="cover-letter"
                                            required />
            ...
            <table class="table" id="my-table">
                <thead>
                    <tr>
                        ...
                        <th class="line">Number of Views</th>
                        <th class="line">Earnings</th>
                    </tr>
                </thead>
                <tbody id="table-body">
            ...
            function populateTable(page) {
                ...
                fetch("table.php")
                    ...
                    .then((data) => {
                        ...
                        <td class="line">${entry.views}</td>
                        <td class="line">${entry.result}</td>
                    `;
