...
<div class="section" id="advertise" style="margin-top: 30px;">
    <div class="container">
        <p style="font-weight: bold; line-height: 1.5;">Advertise With Us <br> Pricing</p>
                ...
                <div class="card shadow" id="gold-package">
                    <div class="card-body" style="text-align: center;">
                            <p class="card-img-top" style="font-size: 24px;">
                                <br>
                                <br>
                                <span style="font-size: 18px; color: #000;">ADVERTISE WITH US</span><br>
                            ...
                            <input type="hidden" name="selected_package" value="Advertise">
                            <input type="hidden" name="selected_cashback" value="4700">
                            <p>
                                Cashback 4,700 <br> Earning Method <br> Referral <br> 100 Per View <br> Games
                            </p>
                            <button class="btn" style="background-color: #f36c33; color: #fff;"
                                    ...
                                    type="submit"onclick="purchasePackage(this)">Purchase
                            </button>
                    </div>
                </div>
                <!-- Card ends here -->
...
<div id="content-wrapp" style="background: #fff; padding: 40px;">
    ...
    <div id="table-container">
        <table class="table" id="my-table">
            ...
            <tbody id="table-body">
                ...
                <tr>
                    <td class="line">4800</td>
                    <td class="line">Diamond</td>
                    <td class="line">10-24-2023 14:47 P.M</td>
                </tr>
                <tr>
                    <td class="line">1300</td>
                    <td class="line">Star</td>
                    <td class="line">10-19-2023 10:17 P.M</td>
                </tr>
            </tbody>
        </table>
    ...
    function populateTable(page) {
        ...
        fetch("advertisefetch.php") // Adjust the path if needed
