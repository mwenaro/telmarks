...
<body>
    ...
    <div class="page-content p-5" id="content">
            ...
            <div class="container">
                <p style="font-weight: bold; line-height: 1.5;" class="text-center">SCREENSHOT DATA</p>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function populateTable(page, search = '') {
        ...
        fetch(`screenshotfetch_admin.php?page=${page}&search=${search}`) // Adjust the path if needed
