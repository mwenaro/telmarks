...
<body>
    ...
    <div class="page-content p-5" id="content">
        ...
        <div class="section" id="trading" style="margin-top: 30px;">
            <div class="container">
                <p style="font-weight: bold; line-height: 1.5;">TRADING BOT <br> Pricing</p>
                        ...
                        <div class="card shadow" id="gold-package">
                            <div class="card-body" style="text-align: center;">
                                <p class="card-img-top" style="font-size: 24px;">
                                    <br>
                                    <span style="font-size: 18px; color: #000;">TRADING BOT</span><br>
                                    <span style="font-size: 18px; color: #000;">KES</span><br>
                                    <span style="font-size: 45px; color: #000;">20,000</span><br>
                                    Lifetime
                                </p>
                                <hr class="mx-auto w-75" />
                                 <input type="hidden" name="selected_amount" value="20000">
                                <input type="hidden" name="selected_package" value="Trading">
                                <input type="hidden" name="selected_cashback" value="14000">
                                <p>
                                    Cashback 14,000 <br> Trades for you Automatically <br> Can Trade Anytime <br> Dont
                                    need to Analyze Market <br> Worry about Market to Trade <br> Accurate for you to
                                    Trade <br> Anytime you want
                                </p>
 ...
 <div id="content-wrapp" style="background: #fff; padding: 40px;">
    ...
    function populateTable(page) {
        ...
        fetch("tradingfetch.php") // Adjust the path if needed
