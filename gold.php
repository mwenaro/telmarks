...
<body>
    ...
    <div class="page-content p-5" id="content">
        ...
        <div class="section" id="gold" style="margin-top: 30px;">
            <div class="container">
                <p style="font-weight: bold; line-height: 1.5;">GOLD MEMBERSHIP <br> Pricing</p>
                        ...
                        <div class="card shadow" id="gold-package">
                            <div class="card-body" style="text-align: center;">
                                <p class="card-img-top" style="font-size: 24px;">
                                    <br>
                                    <br>
                                    <span style="font-size: 18px; color: #000;">GOLD MEMBERSHIP</span><br>
                                ...
                                <input type="hidden" name="selected_package" value="Gold">
                                <input type="hidden" name="selected_cashback" value="7000">
                                <p>
                                    Cashback 7,000 <br> Forex Classes <br> Online Writing <br> Tiktok Earning <br> 110
                                    Per View
                                </p>
 ...
 <div id="content-wrapp" style="background: #fff; padding: 40px;">
    ...
    function populateTable(page) {
        ...
        fetch("goldfetch.php") // Adjust the path if needed
