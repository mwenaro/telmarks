...
<body>
    ...
    <div class="page-content p-5" id="content">
            ...
            <div class="container">
                <p style="font-weight: bold; line-height: 1.5;" class="text-center">SUBMIT WRITING DATA</p>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function populateTable(page, search = '') {
        ...
        fetch(`sub.php?page=${page}&search=${search}&entries=${showEntries.value}`)
    ...
    tableBody.addEventListener("click", (event) => {
        if (event.target.classList.contains("delete-btn")) {
            ...
            console.log("Delete button clicked. ID to delete:", idToDelete);
    ...
    function handleDelete(idToDelete) {
        // Use fetch to send a request to delete the record with the specified id
        fetch(`delete.php?id=${idToDelete}`, {
            method: 'DELETE',
        })
        .then(response => {
            if (!response.ok) {
